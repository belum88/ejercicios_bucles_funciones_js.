const songs = [
  ...
  // Imprimir la nueva playlist por consola
  console.log('Rock Playlist (más de 5 minutos):');
  rockPlaylist.forEach(song => {
    console.log(`${song.title} - ${song.duration} minutos`);
  });
